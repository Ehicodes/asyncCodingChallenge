...
const imgsContainer = document.querySelector('.images')'img/img-1.jpg'
...
.then(img => {
    currentImage = img
    console.log('i have finished loading!! see me!!')
    return wait(2)
})
.then(() => {
...
.then(() => {
    ...
    text.textContent = 'THAT WILL BE ALL, THANK YOU!!'
    imgsContainer.append(text)
})
.catch(err => {
    console.error((err))
})
