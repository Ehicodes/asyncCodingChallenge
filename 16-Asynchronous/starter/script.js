...
const whereAmI = async function() {
 try { //Geolocation
   ...
   //Country data
   const res = await fetch(`https://countries.dev/name/${dataGeo.country}`)
...
const get3Countries = async function(c1, c2, c3){
   ...
   const data =  await Promise.all([getJSON(`https://countries.dev/name/${c1}`),
...
get3Countries('japan', 'iceland', 'tanzania')
*/
...
//    getJSON(`https://countries.dev/name/japan`),
//    getJSON(`https://countries.dev/name/iceland`), 
//    getJSON(`https://countries.dev/name/tanzania`),
//   ])
//   console.log(res[0])
// })()
